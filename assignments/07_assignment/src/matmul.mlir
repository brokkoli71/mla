module {
  aie.device(npu2) {
    func.func private @matmul(memref<8x8xbf16>, memref<8x8xbf16>, memref<8x8xbf16>) attributes {link_with = "matmul.o"}
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        func.call @matmul(%in0, %in1, %out) : (memref<8x8xbf16>, memref<8x8xbf16>, memref<8x8xbf16>) -> ()
