module {
  // benchmark variant: repeats matmul %c_reps times per host launch to
  // amortize host dispatch overhead over many on-chip iterations.
  ...
  aie.device(npu2) {
    func.func private @matmul(memref<2x8x8x8xbf16>, memref<8x2x8x8xbf16>, memref<2x2x8x8xbf16>) attributes {link_with = "matmul_baseline32.o"}
