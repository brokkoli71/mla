...
// vmac.f dm2, dm2, ex0, ex1, r0 ; vlda.conv.fp32.bf16 cml3, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// vmac.f dm3, dm3, ex0, ex3, r0 ; vlda.conv.fp32.bf16 cmh3, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// vmac.f dm4, dm4, ex2, ex1, r0 ; vlda.conv.fp32.bf16 cml4, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// vmac.f dm0, dm0, ex2, ex3, r0 ; vlda.conv.fp32.bf16 cmh4, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// nopv                          ; vlda.conv.fp32.bf16 cml0, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// nopv                          ; vlda.conv.fp32.bf16 cmh0, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// nopv                          ; vlda.conv.fp32.bf16 cml1, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
// nopv                          ; vlda.conv.fp32.bf16 cmh1, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
