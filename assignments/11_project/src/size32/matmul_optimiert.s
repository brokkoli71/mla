...
vmac.f dm4, dm4, ex8, ex9, r0 ; vlda.conv.fp32.bf16 cml2, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx //0000
vmac.f dm0, dm0, ex8, ex11, r0; vlda.conv.fp32.bf16 cmh2, [p2], #64 ; nopb                             ; nops                               ; nopm           ; nopx
vmac.f dm1, dm1, ex10, ex9, r0; vlda.pop.576 ex0, [p0, lf0, r24]    ; vldb.pop.576 ex1, [p1, lf1, r25] ; vst.conv.bf16.fp32 cml0, [p3], #64 ; nopm           ; nopx
vmac.f dm2, dm2, ex10, ex11,r0; vlda.pop.576 ex2, [p0, lf0, r24]    ; vldb.pop.576 ex3, [p1, lf1, r25] ; vst.conv.bf16.fp32 cmh0, [p3], #64 ; nopm           ; nopx
vmac.f dm4, dm4, ex0, ex1, r0 ; nopa                                ; nopb                             ; vst.conv.bf16.fp32 cml1, [p3], #64 ; nopm           ; nopx
vmac.f dm0, dm0, ex0, ex3, r0 ; vlda.pop.576 ex0, [p0, lf0, r24]    ; vldb.pop.576 ex1, [p1, lf1, r25] ; vst.conv.bf16.fp32 cmh1, [p3], #64 ; nopm           ; nopx
vmac.f dm1, dm1, ex2, ex1, r0 ; vlda.pop.576 ex2, [p0, lf0, r24]    ; vldb.pop.576 ex3, [p1, lf1, r25] ; vst.conv.bf16.fp32 cml2, [p3], #64 ; nopm           ; nopx
vmac.f dm2, dm2, ex2, ex3, r0 ; nopa                                ; nopb                             ; vst.conv.bf16.fp32 cmh2, [p3], #64 ; nopm           ; nopx
